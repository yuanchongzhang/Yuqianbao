 ...
 */
public class BankListAdapter2 extends RecyclerView.Adapter<BankListAdapter2.ViewHolder>  implements View.OnClickListener{
    ...
    public BankListAdapter2(Context context, List<JsonBanklist.Info.ListContent> list, int flag) {
