 ...
 */
public class ClaimsManage02Adapter extends RecyclerView.Adapter<ClaimsManage02Adapter.ViewHolder> {


    private Context context;
    private List<JsonUserbond.Info.ListContent> list;

    public ClaimsManage02Adapter(Context context, List<JsonUserbond.Info.ListContent> list) {
...
TextView tv_11;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = BoundViewHelper.boundView(this, MyApplication.scaleScreenHelper.loadView((ViewGroup) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_07_item_view, null)));
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv03.setText(list.get(position).borrow_interest_rate+"%");
        holder.tv06.setText("转让价格： "+list.get(position).transfer_price + "元");
//        holder.tv04.setText(list.get(position).period + "期/" + list.get(position).total_period + "期");
        holder.tv04.setText(list.get(position).period );
        holder.tv_10.setText("/"+list.get(position).total_period );

//        holder.tv05.setText(list.get(position).investor_capital + "元/" + list.get(position).investor_interest + "元");
        holder.tv05.setText(list.get(position).investor_capital );
