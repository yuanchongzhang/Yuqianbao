 ...
 */
public class MyViewPager03Adapter extends PagerAdapter {
    ...
    public MyViewPager03Adapter(Context context, List<View> mListViews, String webUrl01, String webUrl02, List<JsonInvestdetail.Info.InvestListContent> list1, List<JsonInvestdetail.Info.PayingListContent> list2) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        switch (position) {
            ...
            case 3:
                ...
                RecyclerView.Adapter adapter = new ViewPagerListAdapter3(context, (List) list2, 1);
