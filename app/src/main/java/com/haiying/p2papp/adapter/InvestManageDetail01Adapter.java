 ...
 */
public class InvestManageDetail01Adapter extends RecyclerView.Adapter<InvestManageDetail01Adapter.ViewHolder> {
    ...
    public InvestManageDetail01Adapter(Context context, List<JsonTendout.Info.ListContent> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = BoundViewHelper.boundView(this, MyApplication.scaleScreenHelper.loadView((ViewGroup) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_20_item_view, null)));
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
     holder.tv01.setText("标题：" + list.get(position).borrow_name);
        ...
        holder.tv05.setText(list.get(position).breakday + "天");
        holder.tv06.setText(list.get(position).unreceive_money);
        holder.tv07.setText(list.get(position).unreceive_interest + "元");
        holder.tv08.setText(list.get(position).back+"期/" + list.get(position).total+"期");
