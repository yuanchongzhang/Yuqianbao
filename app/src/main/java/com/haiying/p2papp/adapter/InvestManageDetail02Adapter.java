 ...
 */
public class InvestManageDetail02Adapter extends RecyclerView.Adapter<InvestManageDetail02Adapter.ViewHolder> {
    ...
    public InvestManageDetail02Adapter(Context context, List<JsonTendout.Info.ListContent> list) {
